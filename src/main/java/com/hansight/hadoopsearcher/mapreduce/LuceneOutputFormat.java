...
import com.hansight.hadoopsearcher.util.PathFilters;
import com.hansight.hadoopsearcher.util.TaskHeartbeatThread;
 ...
 *
 * @author zhachao, based on code written by Kyle Maxwell
 */
public abstract class LuceneOutputFormat<K, V> extends FileOutputFormat<K, V> {

    private static final Logger LOG = LoggerFactory.getLogger(LuceneOutputFormat.class);

    /**
     * Convert a record from the MR framework into a lucene {@link org.apache.lucene.document.Document}
     * You may re-use the same {@link org.apache.lucene.document.Document} instance for efficiency
     *
     * @param key the key written to this output format
     * @param value the value written to this output format
     * @return a lucene Document suitable for insertion into an {@link org.apache.lucene.index.IndexWriter}
     */
    protected abstract Document buildDocument(K key, V value) throws IOException;

    /**
     * Override this method if you intend to use an {@link org.apache.lucene.analysis.Analyzer}
     ...
     * @return an {@link org.apache.lucene.analysis.Analyzer} suitable for use by an {@link org.apache.lucene.index.IndexWriter}
     */
    ...
    /**
     * Override to use a different {@link org.apache.lucene.store.Directory} implementation
     *
    ...
    public static IndexWriter createIndexWriter(Directory location, Analyzer analyzer, int mergeFactor)
        ...
        IndexWriterConfig idxConfig = new IndexWriterConfig(Version.LUCENE_4_10_4, analyzer);
