...
import com.hansight.hadoopsearcher.mapreduce.LuceneInputFormat.LuceneInputSplit;
 ...
 */
public abstract class LuceneRecordReader<T extends Writable> extends RecordReader<IntWritable, T>{

    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(LuceneRecordReader.class);
     ...
     */
    public abstract Query deserializeQuery(String serializedQuery) throws IOException;
     ...
     * @throws IOException
     */
    public IndexReader openIndex(Path path, Configuration conf) throws IOException {

        System.out.println(path);
        return DirectoryReader.open(new HdfsDirectory(path, conf));
    }
     ...
     */
    public IndexSearcher createSearcher(IndexReader reader) {
    ...
    public void initialize(InputSplit genericSplit, TaskAttemptContext context) throws IOException,
        ...
        List<String> serializedQueries = LuceneInputFormat.getQueries(conf);
        ...
        List<Path> indexes = ((LuceneInputSplit) genericSplit).getIndexDirs();
